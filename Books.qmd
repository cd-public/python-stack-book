...
2. Select the Green Button <button "background-color:green">🖥️New</button>
...
4. Select the Green Button <button "background-color:green">Create repository</button>  
...
2. Follow instructions from [Render to `docs`]([https://quarto.org/docs/publishing/github-pages.html](https://quarto.org/docs/publishing/github-pages.html)) up to `Publish Command`
